...
fungsi_badan_atas("FAUCETWORLD", "1.0.0");
...
while (true) {
	...
	$url = "https://faucetworld.in/payout-to-wallet/?address=".$EC;
	$cookie = "address=".$EC.";currency=%5B%22DOGE%22%5D";
	...
	$var_untuk_fungsi_parsing_html_token = fungsi_parsing_html($var_untuk_fungsi_curl_get_web, '<div class="card center-align orange darken-4 white-text z-depth-2">
Your remaining AutoClaim Tokens: ', '<a', 1);
